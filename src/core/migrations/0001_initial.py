    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "document_en",
                    models.FileField(null=True, upload_to="", verbose_name="document"),
                ),
                (
                    "document_fr",
                    models.FileField(null=True, upload_to="", verbose_name="document"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_hash",
                    models.CharField(max_length=255, verbose_name="user's hash"),
                ),
                (
                    "vote",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "number",
                    models.IntegerField(default=0, null=True, verbose_name="number"),
                ),
                (
                    "question",
                    models.ForeignKey(
